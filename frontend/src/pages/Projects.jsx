...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      tech: [<SiReact className="text-blue-400" />],
  ...
  return (
    <section
      id="projects"
      className="bg-slate-600 py-16 px-6 md:px-20 flex items-center justify-center min-h-screen"
    >
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <img
                src={project.img}
                alt={project.title}
                className="w-full h-40 object-cover bg-blue-400 sm:h-36 md:h-40 "
              />
